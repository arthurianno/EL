...
class GlucoseLevelDirectionTest {
    ...
    fun glucoseLevelDirection_Last_4_PreLast_5_Down() {
        val last = EventTestFactory.create(type = EventType.Glucose(GlucoseInputType.MANUAL), value = 4.0)
        val preLast = EventTestFactory.create(type = EventType.Glucose(GlucoseInputType.MANUAL), value = 5.0)
    ...
    fun glucoseLevelDirection_Last_4_PreLast_4_Stable() {
        val last = EventTestFactory.create(type = EventType.Glucose(GlucoseInputType.MANUAL), value = 4.0)
        val preLast = EventTestFactory.create(type = EventType.Glucose(GlucoseInputType.MANUAL), value = 4.0)
        val direction = last.glucoseLevelDirection(preLast)
    ...
    fun glucoseLevelDirection_Last_5_PreLast_Null_Null() {
        val last = EventTestFactory.create(type = EventType.Glucose(GlucoseInputType.MANUAL), value = 5.0)
