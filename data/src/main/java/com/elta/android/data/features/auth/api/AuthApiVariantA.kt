...
interface AuthApiVariantA {

    @POST("api/auth/v1/accounts")
    fun register(@Body request: AuthNetworkRequestVariantA): Single<TokensNetworkResponse>

    @POST("api/auth/v1/accounts/login")
    fun login(@Body request: AuthNetworkRequestVariantA): Single<LoginNetworkResponse>
