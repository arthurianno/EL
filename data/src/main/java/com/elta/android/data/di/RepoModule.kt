...
import com.elta.android.data.features.diary.insulin.repository.InsulinNameDataRepository
...
abstract class RepoModule {
    ...
    @Binds
    @Singleton
    abstract fun bindInsulinNameRepository(repo: InsulinNameDataRepository): InsulinNameRepository
