...
class SecureUtilsExtensionsTest {
    ...
    fun toMd5String_compareWithOriginalString_NotSuccess() {
        ...
        assertFalse(originalString.toMd5String() == originalString)
    }

    @Test
    fun toMd5String_compareWithEncryptedString_Success() {
        val originalString = this::class.java.simpleName
        assertEquals(originalString.toMd5String(), "4c3ee751490123d90d0497eb11e8109b")
    }

    @Test
    fun toSHA512String_compareWithOriginalString_NotSuccess() {
        val originalString = this::class.java.simpleName
        assertFalse(originalString.toSHA512String() == originalString)
    }
    ...
    fun toSHA512String_compareWithEncryptedString_Success() {
        val originalString = this::class.java.simpleName
        assertEquals(
            originalString.toSHA512String(),
            "bee67cdc56ddfabd11a16673edcee9d72c43a01f8a29b31d38e544efed459caf8dc7a03bf7b846b633cbbc0d779b63ea5d36c1aea369f689633dfa0225c03921"
        )
    }
    ...
    fun toBase64_compareWithOriginalString_NotSuccess() {
        val originalString = this::class.java.simpleName
        assertFalse(originalString.toBase64() == originalString)
    }

    @Test
    fun toBase64_compareWithBase44EncryptedString_Success() {
        val originalString = this::class.java.simpleName
        assertEquals(originalString.toBase64(), "U2VjdXJlVXRpbHNFeHRlbnNpb25zVGVzdA==")
    }
    ...
    fun toBase64_fromBase64EqualsOriginalString_Success() {
        ...
        assertEquals(base64String.fromBase64AsString(), originalString)
    }
    ...
    fun toHexDecimal_compareWithHexDecimalString_Success() {
        val originalString = this::class.java.simpleName
        assertEquals(
            originalString.toByteArray().toHexDecimalString(),
            "5365637572655574696c73457874656e73696f6e7354657374"
        )
    }
    ...
    fun fromHexDecimal_compareWithToHexDecimalResultString_Success() {
        ...
        assertEquals(originalString, hexDecimalString.fromHexDecimalString())
    }
}
