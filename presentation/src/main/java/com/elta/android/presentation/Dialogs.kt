...
sealed class Dialogs : DialogData {
    ...
    data class DeviceBatteryLowLevel(
        val resources: ResourceProvider,
        override val title: String = resources.getString(R.string.firmware_dialog_title),
        override val message: String = resources.getString(R.string.firmware_dialog_message),
        override val negative: String? = null,
        override val positive: String = resources.getString(R.string.firmware_dialog_button)
    ) : Dialogs()
}