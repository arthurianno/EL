...
fun PresentationModel.formSelectorControl(): FormSelectorControl {
    return FormSelectorControl(this)
}

internal inline fun FormSelectorControl.bind(
    selectorView: FormSelectorView, compositeDisposable: CompositeDisposable
) {
