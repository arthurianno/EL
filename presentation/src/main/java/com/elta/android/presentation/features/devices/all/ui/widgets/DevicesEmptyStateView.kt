package com.elta.android.presentation.features.devices.all.ui.widgets
...
class DevicesEmptyStateView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.layout_devices_empty_state, this, true)
    }
