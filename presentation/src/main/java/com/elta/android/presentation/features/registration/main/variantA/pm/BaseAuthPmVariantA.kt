...
import com.elta.android.presentation.DialogsVariantA
...
abstract class BaseAuthPmVariantA(services: ServiceFacade) : BasePm(services) {
    ...
    private val profileIsDeletedDialogData: DialogData by lazy { DialogsVariantA.ProfileIsDeleted(resources) }
