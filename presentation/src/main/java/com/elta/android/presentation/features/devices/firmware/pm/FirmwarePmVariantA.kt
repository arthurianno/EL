...
import com.elta.android.domain.features.devices.interactor.UpdateFirmwareWithBootModeUseCaseVariantA
import com.elta.android.domain.features.devices.interactor.UpdateFirmwareWithDfuModeUseCaseVariantA
...
class FirmwarePmVariantA @Inject constructor(
    ...
    private val updateFirmwareWithBootMode: UpdateFirmwareWithBootModeUseCaseVariantA,
    private val updateFirmwareWithDfuMode: UpdateFirmwareWithDfuModeUseCaseVariantA,
    ...
    override fun handleError(error: Throwable) {
        when (error) {
            ...
            is BluetoothNotEnabledErrorVariantA -> setState(UpdateState.FirmwareUpdateError(resources))
    ...
    private fun updateFirmwareBootMode(): Observable<String> =
        updateFirmwareWithBootMode.execute(
            UpdateFirmwareWithBootModeUseCaseVariantA.Params(
    ...
    private fun updateFirmwareDfuMode(): Observable<String> =
        updateFirmwareWithDfuMode.execute(
            UpdateFirmwareWithDfuModeUseCaseVariantA.Params(
                deviceAddressState.valueOrNull.orEmpty(),
                firmwareFileState.value
            )
        )
