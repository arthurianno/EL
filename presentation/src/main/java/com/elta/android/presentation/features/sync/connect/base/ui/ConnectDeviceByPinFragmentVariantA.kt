...
abstract class ConnectDeviceByPinFragmentVariantA<T : ConnectDevicePmVariantA> :
...
//            menuButtonView.text = getString(R.string.sync_connect_menu_button_text)
    ...
    private fun ConnectDevicePmVariantA.ViewState.getId() =
        when (this) {
            ConnectDevicePmVariantA.ViewState.SEARCH -> R.id.layoutSyncStateSearch
            ConnectDevicePmVariantA.ViewState.FOUND -> R.id.layoutSyncStateDeviceFound
            ConnectDevicePmVariantA.ViewState.CONNECTED -> R.id.layoutSyncStateConnected
            ConnectDevicePmVariantA.ViewState.HOW_TO_CONNECT -> R.id.layoutSyncStateHowToConnect
            ConnectDevicePmVariantA.ViewState.SYNC_COMPLETED -> R.id.layoutSyncStateSyncCompleted
            ConnectDevicePmVariantA.ViewState.SYNC_ERROR -> R.id.layoutSyncStateSyncError
            ConnectDevicePmVariantA.ViewState.NOT_FOUND -> R.id.layoutSyncStateNotFound
        }
}
